...
function showCategory(category) {
    let productsOfCategory = products[category];

    for (let p in productsOfCategory) {
        productsElem.insertAdjacentHTML('beforeend', getProductMarkup(productsOfCategory[p]));
    }
}
